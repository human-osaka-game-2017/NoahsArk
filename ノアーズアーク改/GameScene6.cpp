...
void GameSceneDraw()
{
	...
	if (elephant2.Active)
	{
		...
		// 描画
		g_pDirect3DDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2, drawelephant2, sizeof(CUSTOMVERTEX));
	}
	...
	if (lion2.Active)
	{
		...
		// 描画
		g_pDirect3DDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2, drawlion2, sizeof(CUSTOMVERTEX));
	}
	if (risu4.Active)
	{
		// テクスチャをステージに割り当てる
		...
		// 描画
		g_pDirect3DDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2, drawrisu4, sizeof(CUSTOMVERTEX));
	}
	if (tree7.Active)
	{
		// テクスチャをステージに割り当てる
		...
		// 描画
		g_pDirect3DDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2, drawtree7, sizeof(CUSTOMVERTEX));
	}
	if (chestnut6.Active)
	{
		// テクスチャをステージに割り当てる
		...
		// 描画
		g_pDirect3DDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2, drawchestnut6, sizeof(CUSTOMVERTEX));
	}
	//テクスチャをステージに割り当てる
